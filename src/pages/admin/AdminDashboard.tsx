...
type AdminTab = "rides" | "drivers" | "monitor" | "payouts" | "finance" | "reports" | "audit" | "health" | "readiness" | "actions";
    ...
    <div style={pageStyle()}>      <h1 style={{ marginTop: 0, marginBottom: 0 }}>TrueGo Admin Dashboard</h1>
      ...
      >
        ...
        <button
          ...
          style={tabButtonStyle(activeTab === "readiness")}
        >
          Readiness
        </button>
      ...
      {activeTab === "readiness" ? <AdminReadinessPanel /> : null}
