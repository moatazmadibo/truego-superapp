-- =========================================================
-- TrueGo Admin Driver Review RPC Argument Fix
-- Drops and recreates the protected RPC so parameter names match frontend payload.
-- Fixes: cannot change name of input parameter "p_admin_notes"
-- =========================================================
...
-- Keep the old direct review RPC blocked from frontend callers.
