-- =========================================================
-- TrueGo: preserve inDrive-style collecting_offers from legacy timeout
-- The old demo dispatch timeout must not convert collecting_offers to no_driver_available.
-- collecting_offers should be controlled by ride_driver_offers flow only.
-- =========================================================
